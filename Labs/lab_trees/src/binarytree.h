...
class BinaryTree
{
    public:
         ...
         *  criterion for a binary tree to be a binary search tree.
         */
        bool isOrderedHelper(const Node* subRoot) const;
        Node* LeftVal(typename BinaryTree<T>::Node *subRoot) const;
        Node* RightVal(typename BinaryTree<T>::Node *subRoot) const;
    ...
    private:
        ...
        void traverseTree(Node * subRoot);
